...
| | |
|---|---|
| Contratos | v1.3.0, congelados. 33 verificaciones en `python -m contratos.verificar` |
...
| Backlog | 84 historias, 422 puntos. Completo en `docs/08-backlog.md`, por persona en `docs/tareas/` |
