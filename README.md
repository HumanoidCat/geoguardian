...
| | |
|---|---|
| Contratos | v1.5.0, congelados. 47 verificaciones en `python -m contratos.verificar` |
...
| Backlog | 103 historias, 514 puntos. Completo en `docs/08-backlog.md`, por persona en `docs/tareas/` |
