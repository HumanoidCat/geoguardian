...
| H2.3 | SPI por ventana movil, sobre la serie cruda (D-17) | backend/senales | test_spi, 21 casos | docs/evidencias/senales-y-sistemas/H2.3-spi.md | Senales | Luna | **Con evidencia** · SC-02 resuelta por D-19: falta que la implementacion use el parametro `meses` |
...
| H6.6 | El visor consume la API real en lugar de los JSON estaticos | frontend/src/datos/cliente.js, backend/api | verificacion de punta a punta con la API levantada | docs/evidencias/arquitectura-software/H6.6-visor-contra-api.md | Arq | Alejandro | **Con evidencia** |
