...
| H1.9 | Control transaccional con manejo de errores | basedatos/procedimientos | test_rollback | docs/evidencias/bases-de-datos/ | BD-3 | Alejandro | Pendiente |
...
| H1.15 | Crear analitico.riesgo con sus restricciones | basedatos/ddl | test_analitico_riesgo | docs/evidencias/bases-de-datos/ | BD-2 | Alejandro | Pendiente |
