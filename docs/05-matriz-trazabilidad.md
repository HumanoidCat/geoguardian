...
| H5.6 | Transformacion de coordenadas | frontend | test_proyeccion | docs/evidencias/computacion-grafica/H5.6-proyeccion-crtm05.md | CG-1 | Alejandro | **Con evidencia** |
