...
Tienen que pasar las **47 verificaciones**, y arriba debe decir **"Contratos version 1.5.0"**. Dos de ellas comprueban que los códigos de distrito sean los oficiales del cantón de Tilarán, `508xx`.
