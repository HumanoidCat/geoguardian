...
*Nota de verificacion.* Una version anterior de esta solicitud atribuia el
ajuste por mes tambien a la guia operativa de la OMM, WMO-No. 1090, referencia
`[24]`. **Esa atribucion no se ha podido confirmar textualmente** y se retira
hasta verificarla contra el documento. Es lo que hacen las implementaciones de
referencia, pero eso es un argumento distinto de una cita.

**La solicitud no depende de la cita.** El argumento que la sostiene es la
