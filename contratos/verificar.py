...
def main() -> int:
    ...
    m = MedicionDiaria(codigo_distrito="50501", fecha=date(2026, 1, 1), precipitacion_mm=0.0)
    ...
    serie = repo.obtener_mediciones("50501", date(2026, 1, 1), date(2026, 1, 31))
    ...
    r = Riesgo(codigo_distrito="50501", fecha=date(2026, 1, 1), tipo_evento=TipoEvento.SEQUIA)
